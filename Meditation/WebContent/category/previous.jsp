...
<div class="previous-wrap">
	...
	<section id="recommend">
		<div class="recommend-wrap container-12">
			...
			<div
				class="recommend-imgs d-flex align-items-center justify-content-between mt-4">
				...
				<a
					...
					class="recommend-img"> <img src="<%=vo.getImgUrl()%>"
					alt="video-img">
				</a>
				<%
					}
		...
		<div class="comment-wrap container-12">
			...
			<div class="comment-form" name="commentForm">
				<form action="<%=request.getContextPath()%>/comment"
					...
					method="post">
					<input type="hidden" value="2" class="viNum" name="viNum">
			...
			<div class="comments">
				<%
					...
					ArrayList<CommentVO> coList = coDao.getComment(2);
