...
insert into video values(video_seq.nextval,'P','설시문',default,'혼자하는 전생체험 최면','저는 최면에서 떠올린 전생기억이나 전생경험이 사실이라고 주장하지 않습니다. 하지만 내면, 잠재의식, 무의식을 탐사하는데 참고가 되는 중요한 정보나 자료가 된다고는 믿습니다.', 'video6.mp4', 'image6.png');
...
insert into video values(video_seq.nextval,'F','몸마음주파수',default,'뇌건강 시리즈#1 트레온산 마그네슘 추출 주파수 음악','마그네슘은 체내에서 300가지 이상의 생화학적 반응에 필수적이며, 신경계와 뇌에 중요한 역할을 합니다. 하지만 대부분의 식단에는 마그네슘이 부족하며, 나이가 들수록 마그네슘 수치는 적정치에서 멀어집니다.', 'video13.mp4', 'image13.png');
insert into video values(video_seq.nextval,'F','에너지힐링주파수',default,'🍀이 영상이 당신에게 뜨면 좋은징조에요 엔젤주파수Attract Love Subliminal','오늘은 영감이 너무 좋았어요!좋은 느낌과 기운은 저만 가지고 있을 순 없죠! 함께하고 싶습니다!', 'video14.mp4', 'image14.png');
